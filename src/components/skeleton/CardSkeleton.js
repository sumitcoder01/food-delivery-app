...
export default function CardSkeleton() {
    return (
        <div className="card bg-dark text-white fst-italic my-3 border border-success rounded" style={{ width: "20rem" }}>
            <div style={{ height: "198px", backgroundColor: "#353935" }}></div>
            <div className="card-body text-center">
                <span className="card-title" style={{ backgroundColor: "#353935", height: "20px" }}></span>
                <div className="d-flex justify-content-center my-4">
                    ...
                    <div className="mx-1 d-flex flex-column align-items-center">
                        ...
                        <select className="form-select bg-success text-white" style={{ backgroundColor: "#353935", height: "30px" }} disabled>
                            <option></option>
                        </select>
                    </div>
                    {/* Size Dropdown */}
                ...
                {/* Add To Cart Button */}
                <button disabled className="btn btn-success" style={{ backgroundColor: "#353935" }}></button>
            </div>
        </div>
    )
}
